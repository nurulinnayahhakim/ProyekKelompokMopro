...
public class DaftarBarang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent inte = new Intent(DaftarBarang.this, InputActivity.class);
                startActivity(inte);
            }
        });
        da = this;
    ...
    public void RefreshList() {
        ...
        cursor = db.rawQuery("SELECT * FROM daftarbarang", null);
        ...
        ListView01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DaftarBarang.this);
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        switch (item) {
                            ...
                            case 1:
                                ...
                                db.execSQL("delete from daftarbarang where nama = '"+selection+"'");
                                RefreshList();
                                break;
                        }
                    }
